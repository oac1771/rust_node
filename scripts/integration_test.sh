...
curl -v -X POST -H 'Content-Type: application/json' -d '{"principal_address": "0x8002cD98Cfb563492A6fB3E7C8243b7B9Ad4cc92", "meta_data": "info", "data": {"foo": "hi"}}' http://localhost:3000/register